...
namespace WindowsFormsApp1 {
    ...
    public partial class DataSet3 : global::System.Data.DataSet {
        ...
        public partial class DataTable1DataTable : global::System.Data.TypedTableBase<DataTable1Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public DataTable1Row AddDataTable1Row(string nombre, string apellidos, string telefono, string DNI, string domicilio, string localidad, System.DateTime fecha, double precio_total) {
        ...
        public partial class DataTable1Row : global::System.Data.DataRow {
            ...
            public double precio_total {
                get {
                    try {
                        return ((double)(this[this.tableDataTable1.precio_totalColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace WindowsFormsApp1.DataSet3TableAdapters {
    ...
    public partial class DataTable1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT        clientes.nombre, clientes.apellidos, clientes.telefono, clientes.DNI, clientes.domicilio, clientes.localidad, facturas.fecha, facturas.precio_total
FROM            clientes INNER JOIN
                         facturas ON clientes.id = facturas.id_cliente
WHERE        (clientes.id = @x)";
        ...
        public virtual int Fill(DataSet3.DataTable1DataTable dataTable, int x) {
        ...
        public virtual DataSet3.DataTable1DataTable GetData(int x) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(x));
